...
const artLabels = {
  ...
  "c-maroon": "えんじ色のパーツ",
  "stripe-reds": "赤白のしま模様",
  "stripe-blue-white": "青白のしま模様",
  "stripe-red-white": "赤白の細かいしま模様",
  "sym-star": "黄色い星",
  "sym-white-star": "白い星",
  "sym-green-star": "緑の星",
  "sym-red-disc": "赤い丸",
  ...
  "sym-maple": "カエデの葉",
  "sym-crescent": "白い三日月",
  "sym-crescent-star": "白い三日月と星",
  "sym-yellow-crescent": "黄色い三日月",
  "sym-taegeuk": "太極マーク",
  ...
  "cross-red": "赤い十字",
  "jamaica-base": "ジャマイカの黒と緑",
  "jamaica-saltire": "黄色いX字",
  "tanzania-base": "タンザニアの緑と水色",
  "tanzania-yellow-band": "黄色い斜め帯",
  "tanzania-black-band": "黒い斜め帯",
  "cross-white": "白い十字",
  "cross-blue": "青い十字",
  "cross-yellow": "黄色い十字",
  "nordic-white": "白い北欧十字",
  "nordic-blue": "青い北欧十字",
  "nordic-blue-inner": "細い青い北欧十字",
...
const countryPlans = [
  ...
  { country: "ノルウェー", english: "Norway", pieces: [...field("c-red"), piece("nordic-white", 0, 0, 100, 100, 2), piece("nordic-blue-inner", 0, 0, 100, 100, 3)] },
  { country: "トルコ", english: "Turkey", pieces: [...field("c-red"), piece("sym-crescent-star", 32, 30, 30, 40, 2)] },
  ...
  { country: "パキスタン", english: "Pakistan", pieces: [piece("c-white", 0, 0, 25, 100), piece("c-deep-green", 25, 0, 75, 100), piece("sym-crescent-star", 50, 29, 28, 40, 2)] },
  ...
  { country: "フィリピン", english: "Philippines", pieces: [piece("c-blue", 0, 0, 100, 50), piece("c-red", 0, 50, 100, 50), piece("shape-triangle-white", 0, 0, 42, 100, 2), piece("sym-sun", 11, 40, 12, 20, 3), piece("philippines-stars", 4, 8, 34, 84, 3)] },
  ...
  { country: "ジャマイカ", english: "Jamaica", pieces: [piece("jamaica-base", 0, 0, 100, 100, 1), piece("jamaica-saltire", 0, 0, 100, 100, 2)] },
  ...
  { country: "シンガポール", english: "Singapore", pieces: [piece("c-red", 0, 0, 100, 50), piece("c-white", 0, 50, 100, 50), piece("sym-crescent", 12, 12, 24, 28, 2), piece("singapore-stars", 34, 11, 22, 28, 2)] },
  { country: "マレーシア", english: "Malaysia", pieces: [piece("stripe-red-white", 0, 0, 100, 100), piece("c-blue", 0, 0, 44, 54, 2), piece("sym-yellow-crescent", 9, 11, 22, 30, 3), piece("sym-star", 28, 17, 12, 18, 3)] },
